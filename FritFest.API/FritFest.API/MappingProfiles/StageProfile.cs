        ...
        public StageProfile()
        {
            ...
            CreateMap<StageDto, Stage>()
                .ForMember(dest => dest.Location,
                    opt => opt.Ignore()) // Ignore Locatie on reverse mapping to avoid circular reference issues
                .ForMember(dest => dest.TimeSlots,
                    opt => opt.Ignore()); // Optionally ignore TijdStip if not directly needed for creation
