...
namespace FritFest.API.Controllers
{
    ...
    public class MailController : Controller
    {
        ...
        public async Task<IActionResult> SendMail([FromBody] MailData emailRequest)
        {
            ...
            string templatePath = "https://raw.githubusercontent.com/itfactory-tm/2024-AngularChallengeBack-07/refs/heads/main/FritFest.API/FritFest.API/MailTemplates/BoughtTicketsMail.html?token=GHSAT0AAAAAACX4V2HAWWJOD4A3V4SLY5GWZ2TA37A";
